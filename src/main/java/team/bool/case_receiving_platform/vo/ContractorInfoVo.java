...
public class ContractorInfoVo extends UserInfo {
...
//	private boolean lockedStatus;
	...
	public ContractorInfoVo(UUID uuid, String email, String userName, String phone, double rating, String resumePdfPath,
			boolean isAdministrator, boolean lockedStatus) {
		super(uuid,email,userName,phone,rating,resumePdfPath, isAdministrator,lockedStatus);
//		this.uuid = uuid;
//		this.email = email;
